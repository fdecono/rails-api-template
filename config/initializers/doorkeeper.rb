...
Doorkeeper.configure do
  ...
  # This is used for protecting resources, not for the initial authentication flow.
  resource_owner_authenticator do
    # For API-only applications, we'll use token-based authentication
    # This will be called when using token-based authentication
    User.find_by(id: doorkeeper_token&.resource_owner_id) if doorkeeper_token
  end

  # This block will be called to authenticate the resource owner during the password grant flow.
  resource_owner_from_credentials do |_doorkeeper_client|
